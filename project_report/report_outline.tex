...
%	\blindtext
	...
	\subsection{Dataset}
	Dataset that we used is MNIST database of handwritten digits. This dataset has pixel values (integers from 0 to 255) for 60,000 training examples. The MNIST database contains a separate testing set of 10,000 examples. The 60,000 pattern training set contained examples from approximately 250 writers.\cite{MNISTDatabase}
